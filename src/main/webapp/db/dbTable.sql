CREATE TABLE "USER" (
    USER_ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY(START WITH 10000, INCREMENT BY 1),
...
CREATE TABLE "CUSTOMER" (
    CUST_ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY(START WITH 100, INCREMENT BY 1),
    USER_ID INTEGER NOT NULL,
    PRIMARY KEY(CUST_ID),
    CONSTRAINT CUST_FK FOREIGN KEY (USER_ID) REFERENCES "USER"(USER_ID)
);

CREATE TABLE "STAFF" (
    STAFF_ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY(START WITH 100, INCREMENT BY 1),
    USER_ID INTEGER NOT NULL,
    ROLE VARCHAR(255) NOT NULL,
    PRIMARY KEY(STAFF_ID),
    CONSTRAINT STAFF_FK FOREIGN KEY (USER_ID) REFERENCES "USER"(USER_ID)
);

CREATE TABLE "ACCESS_LOG" (
    DATE VARCHAR(255) NOT NULL,
    USER_ID INTEGER NOT NULL,
    CONSTRAINT ACCESS_FK FOREIGN KEY (USER_ID) REFERENCES "USER"(USER_ID)
);
